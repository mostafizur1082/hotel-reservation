...
<head>
    ...
    <style>
        ...
        * {
        ...
        .bee-row-3 .bee-row-content {
            background-image:
            url('https://d1oco4z2z1fhwp.cloudfront.net/templates/default/7326/hero-background.png');
            ...
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w5">
                    ...
                    <div class="bee-block bee-block-2 bee-heading">
                        <h1
                            style="color:#199e59;direction:ltr;font-family:
                            'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;
                            font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;
                            text-align:left;margin-top:0;margin-bottom:0;">
                            Hotel Dream Crown<br /> </h1>
                    </div>
                    <div class="bee-block bee-block-3 bee-paragraph">
                        <p>  Hotel Dream Crown is located on a peaceful location in Cox's Bazar,<br/>
                            just a few minutes away from the old city center. It's a cozy family <br/>
                            hotel with a long tradition, all of which makes you feel like at home.</p>
                    </div>
                ...
                <div class="bee-col bee-col-2 bee-col-w8">
                    <div class="bee-block bee-block-1 bee-paragraph">
                        <p><strong>Hello Sir </strong><br />
                            <strong>Your Request is confirm on this data. </strong></p>
                        ...
                        <p>Thank you for choosing Hotel Dream Crown for your stay.<br/>
                            Our commitment to service and guest satisfaction is our main concern.<br/>
                            We have tried to anticipate your needs, however, if there is anything that <br/>
                            we have overlooked, please let us know by providing us feedback on <br/>
                            Hotel Dream Crown website.</p>
                    </div>
            ...
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-3 bee-col-w3">
                    ...
                    <div class="bee-block bee-block-2 bee-text">
                        <div class="bee-text-content"
                            style="line-height: 150%; font-size: 12px; font-family: inherit; color: #fafafa;">
                            <p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">Cox's Bazar, Bangladesh</span></p>
                            <p style="line-height: 18px; text-align: center;"><span
                                    style="line-height: 18px;">hoteldreamcrown@gmail.com</span></p>
                ...
                <div class="bee-col bee-col-1 bee-col-w12">
                    <div class="bee-block bee-block-1 bee-text">
                        <div class="bee-text-content"
                            ...
                            <p style="font-size: 14px; line-height: 16px; text-align: center;"><span
                                    style="font-size: 12px; line-height: 14px;">2023 © All Rights Reserved</span></p>
                        </div>
                    </div>
                </div>
            </div>
