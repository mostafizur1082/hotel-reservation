...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>Hotel Dream Crown</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               Dream Crown Head Office
               Email:dreamcrown@gmail.com <br>
               Mob: 1245454545 <br>
               Dhaka 1207,Shyamoli:#02 <br>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                <h2 style="color: green; font-size: 26px;"><strong>Customer Information</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               Name: {{ $editData->name }}
               Email:{{ $editData->email }} <br>
               Mob: {{ $editData->phone }} <br>
