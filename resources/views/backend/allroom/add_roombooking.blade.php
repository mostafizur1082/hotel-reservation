...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Add Room Booking</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Add Room Booking</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="{{ route('store.room.booking') }}" class="row g-3">
                                    @csrf
                                    <div class="col-md-4">
